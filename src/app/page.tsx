...
import { Download, ArrowRight, Github, Youtube, Linkedin, Instagram } from "lucide-react"
...
export default function Portfolio() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 dark:bg-gray-900 bg-gray-50`}>
      {/* Header */}
      {/* Main Content */}
      <main className="px-6 lg:px-12 pb-12 pt-20">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl/[3.3rem] md:text-5xl/[3.3rem] lg:text-6xl/[3.3rem] font-bold text-gray-900 dark:text-white leading-tight">
                  Hi, I am <span className="text-blue-600 dark:text-blue-400">Naufal</span>
                  <br />
                  Harits Prasetia
                </h1>

                <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-lg">
                  I build responsive, accessible web applications with modern technologies and clean, maintainable code.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 px-8 py-3 rounded-lg font-medium bg-transparent"
                >
              ...
              {/* Social Links */}
              <div className="pt-8">
                <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Find me on:</p>
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-200 via-purple-200 to-green-200 dark:from-blue-800 dark:via-purple-800 dark:to-green-800 rounded-full"></div>
                ...
                <div className="absolute -top-4 -right-4 lg:-right-8">
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg px-4 py-2 border border-gray-200 dark:border-gray-700">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">Full Stack Web</p>
                ...
                <div className="absolute -bottom-8 -left-4 lg:-left-8">
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg px-4 py-2 border border-gray-200 dark:border-gray-700">
                    <p className="text-xs text-gray-600 dark:text-gray-400">Expert in</p>
                    <p className="text-sm font-bold text-gray-900 dark:text-white">Next.js & Laravel</p>
                  </div>
                </div>
              </div>
            </div>
